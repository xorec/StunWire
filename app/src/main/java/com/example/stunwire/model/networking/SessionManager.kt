...
import com.example.stunwire.model.db.SessionsRepository
import com.example.stunwire.StunWireApp
import com.example.stunwire.createSessionDatabaseName
import com.example.stunwire.model.crypto.decrypt
import com.example.stunwire.model.crypto.encrypt
import com.example.stunwire.model.crypto.importPartnerIdentityCertificate
import com.example.stunwire.model.crypto.loadMyIdentityKeyPair
import com.example.stunwire.model.crypto.performKeyAgreement
import com.example.stunwire.model.crypto.generateMyEphemeralKeyPair
import com.example.stunwire.model.crypto.signMyEphemeralCertificate
import com.example.stunwire.model.crypto.verifyPartnerEphemeralCertificate
import com.example.stunwire.model.db.SessionMessage
import com.example.stunwire.model.db.SessionMessageStatus
import com.example.stunwire.model.db.SessionMessageType
import com.example.stunwire.eightBytesToLongBigEndian
import com.example.stunwire.extractMappedAddress
import com.example.stunwire.fourBytesToIntBigEndian
import com.example.stunwire.intToBytes
import com.example.stunwire.log
import com.example.stunwire.longToBytes
import com.example.stunwire.twoBytesToBufferBigEndian
import com.example.stunwire.twoBytesToIntBigEndian
...
const val RCV_BUFFER_SIZE = 1472
...
// + 16 bytes (auth tag)
const val MESSAGE_CHUNK_SIZE = RCV_BUFFER_SIZE - 40
                            ...
                            while (!socket.isClosed && isActive) {
                                try {
                                    ...
                                    if (receivedMessageType == MessageType.MESSAGE_TYPE_ENCRYPTED) {
                                        ...
                                        log("RECEIVED SUBTYPE: ${receivedMessageSubtype.name}")
                                    ...
                                    } else log("RECEIVED UNENCRYPTED MESSAGE")
